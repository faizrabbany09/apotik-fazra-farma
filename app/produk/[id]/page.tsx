...
export default function ProductDetail({ params }: { params: Promise<{ id: string }> }) {
  ...
  const executeAction = (type: 'cart' | 'buy') => {
    if (type === 'cart') {
      console.log(`[STATE] Menambahkan ${quantity}x ${product.title} ke state keranjang global.`);
    } else {
      console.log(`[STATE] Menambahkan ${quantity}x ${product.title} ke state keranjang dan Redirect ke Checkout.`);
      ...
      <div className="space-y-6 pb-24 md:pb-0 relative z-0">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden flex flex-col md:flex-row">
          ...
          <div className="w-full md:w-5/12 lg:w-1/3 bg-slate-50 p-8 flex items-center justify-center border-b md:border-b-0 md:border-r border-slate-100 min-h-[300px]">
            <div className="w-full h-full max-w-[250px] aspect-square bg-white rounded-xl shadow-sm border border-slate-100 flex flex-col items-center justify-center text-slate-300">
              ...
              <div className="flex flex-col md:flex-row gap-4">
                ...
                <div className="flex flex-col sm:flex-row gap-3 flex-1">
                  <button 
                    ...
                    className="flex-1 font-bold py-3.5 px-4 rounded-lg flex items-center justify-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white shadow-md shadow-emerald-600/20 transition-colors active:scale-[0.98]"
                  >
